...
/**
 * \file    lmdbcrm/core/boxes/lmdbcrmwidget1.php
 * \ingroup lmdbcrm
 * \brief   Widget provided by LmdbCrm
 *
 ...
 */
class lmdbcrmwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "lmdbcrmbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "lmdbcrm@lmdbcrm";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// $this->hidden = !$user->hasRight('lmdbcrm', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/lmdbcrm/class/lmdbcrm.class.php");

		// Populate the head at runtime
		$text = $langs->trans("LmdbCrmBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_lmdbcrm@lmdbcrm',
