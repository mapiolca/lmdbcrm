...
- Widget devis signés : filtre de période multi-années avec valeur par défaut sur l'année en cours.
...
- Signed quotes widget: multi-year period filter with defaults set to the current year.
